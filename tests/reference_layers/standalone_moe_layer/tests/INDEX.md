# Directory Index: `/tests/reference_layers/standalone_moe_layer/tests/`

> Reference package smoke and interface tests.
...
| `test_imports_and_interfaces.py` | Tests for moe_standalone package. | — |
