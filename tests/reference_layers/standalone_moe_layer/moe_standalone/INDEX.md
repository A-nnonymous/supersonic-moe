# Directory Index: `/tests/reference_layers/standalone_moe_layer/moe_standalone/`

> Importable reference package namespace.
...
| Path | Summary | Notes |
| --- | --- | --- |
| `moe/` | Reference MoE layer and gating components. | — |
| `token_dispatcher/` | Reference token-dispatch helpers and FP8 utility code. | — |

## Files
| File | Summary | Notes |
| --- | --- | --- |
| `__init__.py` | Package marker for test discovery. | — |
| `compat.py` | Compatibility shim layer. | — |
