# Directory Index: `/tests/reference_layers/`

> Reference implementations vendored for compatibility and behavior checks.
...
| Path | Summary | Notes |
| --- | --- | --- |
| `standalone_moe_layer/` | Standalone reference MoE package used for interface and behavior comparison. | — |
