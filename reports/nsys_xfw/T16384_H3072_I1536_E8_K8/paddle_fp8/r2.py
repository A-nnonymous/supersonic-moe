...
data_dir, S, H, I, E, K = "/tmp/moe_xfw_6hm2_6e6/T16K-E8/seed42", 16384, 3072, 1536, 8, 8
FP8_ALIGN = 128
mode = "nsys"
warmup, iters = 5, 20
USE_FP8 = True  # True for FP8 path, False for BF16 path
OUTPUT_PREFIX = "paddle_fp8"
...
if mode == "precision":
    ...
    # Measured forward (includes permute + unpermute)
    o3, output, up_measured = run_fwd()
    paddle.device.synchronize()
    peak_mem = paddle.device.cuda.max_memory_allocated() / (1024**2)
