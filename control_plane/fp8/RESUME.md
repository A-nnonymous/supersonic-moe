...
7. `control_plane/fp8/status/agents/`
8. `control_plane/fp8/checkpoints/agents/`
9. `control_plane/fp8/experiments/registry.yaml`
10. `control_plane/fp8/strategy/integration_plan.md`
11. `control_plane/fp8/strategy/baseline_trace.md`
...
7. 阅读 control_plane/fp8/status/agents/ 下全部 agent 状态
8. 阅读 control_plane/fp8/checkpoints/agents/ 下全部 agent checkpoint
9. 阅读 control_plane/fp8/experiments/registry.yaml
10. 阅读 control_plane/fp8/strategy/integration_plan.md
11. 阅读 control_plane/fp8/strategy/baseline_trace.md
