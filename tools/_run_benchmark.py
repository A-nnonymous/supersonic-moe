"""Three-way benchmark: SonicMoE BF16 vs FP8 (multi-shape, precision+perf+memory)."""
...
# Clear any leftover FP8 env vars so defaults apply
...
SHAPES = [
    ...
    dict(name="S3", T=4096, H=4096, I=4096,  E=128, K=8, desc="large-I"),
    dict(name="S4", T=8192, H=3072, I=1536,  E=8,   K=8, desc="production"),
    dict(name="S5", T=8192, H=4096, I=2048,  E=128, K=8, desc="large-T"),
]
WARMUP, BENCH_ITERS, SEEDS = 5, 10, [42, 123, 777]
...
if __name__=="__main__":
    print("="*80)
    print("THREE-WAY BENCHMARK: SonicMoE BF16 vs FP8")
