# Directory Index: `/.claude/`

> Local Claude editor / workflow metadata used during iterative development.
...
| Path | Summary | Notes |
| --- | --- | --- |
| `plans/` | Ad hoc planning notes created during previous development sessions. | — |

## Files
| File | Summary | Notes |
| --- | --- | --- |
| `settings.local.json` | JSON artifact with top-level keys: `permissions`. | local editor settings |
